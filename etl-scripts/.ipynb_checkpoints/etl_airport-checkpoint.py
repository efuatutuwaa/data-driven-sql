    ...
    def transform_airport(self, airport_data):
        ...
        for airport in airport_data:
            transformed_airport_data.append((
                airport.get("airport_name") or 'Unknown',
                airport.get("iata_code") or 'Unknown',
                airport.get("icao_code") or 'Unknown',
                airport.get("latitude") or -999,
                airport.get("longitude") or -999,
                airport.get("geoname_id") or 0,
                airport.get("timezone") or 'Unknown',
                airport.get("gmt") or 0,
                airport.get("country_iso2") or 'Unknown',
                airport.get("city_iata_code") or 'Unknown',
                airport.get('id')
            ))
